                ...
                items: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {text: 'Start Typing ⚠️', link: '/api/send-messages/start-typing'},
                            {text: 'Stop Typing ⚠️', link: '/api/send-messages/stop-typing'},
                        ]
                    },
                    {
                        text: '🆔 Profile',
                        ...
                        items:[
                            {
                                ...
                                collapsed: false,
                                items: [
                                    {text: 'All Contacts ⚠️', link: '/api/contacts/c.us/all-contacts'},
