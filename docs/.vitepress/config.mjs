            ...
            },
            {
                ...
                items: [
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    {text: 'Send Link Custom Preview', link: '/api/send-messages/send-link-custom-preview'},
                                ]
                            },
                            {
                                text: '📂 Media Messages',
                            ...
                            },
                            {
                                ...
                                items: [
                                    ...
                                    {text: 'Send Buttons Reply', link: '/api/send-messages/send-buttons-reply'},
                                ]
                            },
                            {
                                text: '⚙️ Message Actions',
                                collapsed: true,
                                items: [
                                    {text: 'Forward Message', link: '/api/send-messages/forward-message'},
                                    {text: 'Send Reaction', link: '/api/send-messages/send-reaction'},
                                    {text: 'Star Message', link: '/api/send-messages/star-message'},
                                    {text: 'Send Seen', link: '/api/send-messages/send-seen'},
                                ]
                            },
                            {
                                text: '🔍 Retrieval & Utils',
                                collapsed: true,
                                items: [
                                    {text: 'Send Contact Vcard', link: '/api/send-messages/send-contact-vcard'},
                                ]
                            },
                            {
                                text: '⌨️ Presence',
                    ...
                    },
                    {
                        ...
                        collapsed: true,
                        items: [
                            {text: 'Convert Voice', link: '/api/media/convert-voice'},
                            {text: 'Convert Video', link: '/api/media/convert-video'},
                        ]
                    },
                    {
                        text: '🆔 Profile',
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {text: 'Chat Data', link: '/reference/dto/chat-data'},
                            {text: 'Chat Request Data', link: '/reference/dto/chat-request-data'},
                            {text: 'Contact Data', link: '/reference/dto/contact-data'},
                            {text: 'Contact Update Data', link: '/reference/dto/contact-update-data'},
                            {text: 'Health Check Data', link: '/reference/dto/health-check-data'},
                            {text: 'Health Indicator Data', link: '/reference/dto/health-indicator-data'},
                            {text: 'Image Status Data', link: '/reference/dto/image-status-data'},
                            {text: 'Lid Data', link: '/reference/dto/lid-data'},
                            {text: 'Link Preview Data', link: '/reference/dto/link-preview-data'},
                            {text: 'Media Convert Data', link: '/reference/dto/media-convert-data'},
                            {text: 'Message Button Reply Data', link: '/reference/dto/message-button-reply-data'},
                            {text: 'Message Contact Vcard Data', link: '/reference/dto/message-contact-vcard-data'},
                            {text: 'Message File Data', link: '/reference/dto/message-file-data'},
                            {text: 'Message Forward Data', link: '/reference/dto/message-forward-data'},
                            {text: 'Message Image Data', link: '/reference/dto/message-image-data'},
                            {text: 'Message Link Custom Preview Data', link: '/reference/dto/message-link-custom-preview-data'},
                            {text: 'Message List Data', link: '/reference/dto/message-list-data'},
                            {text: 'Message List Row Data', link: '/reference/dto/message-list-row-data'},
                            {text: 'Message List Section Data', link: '/reference/dto/message-list-section-data'},
                            ...
                            {text: 'Message Reaction Data', link: '/reference/dto/message-reaction-data'},
                            {text: 'Message Star Data', link: '/reference/dto/message-star-data'},
                            {text: 'Message Text Data', link: '/reference/dto/message-text-data'},
                            {text: 'Message Update Data', link: '/reference/dto/message-update-data'},
                            {text: 'Message Video Data', link: '/reference/dto/message-video-data'},
                            {text: 'Message Voice Data', link: '/reference/dto/message-voice-data'},
                            {text: 'Phone Number Data', link: '/reference/dto/phone-number-data'},
                            {text: 'Ping Response Data', link: '/reference/dto/ping-response-data'},
                            {text: 'Poll Data', link: '/reference/dto/poll-data'},
                            {text: 'Presence Data', link: '/reference/dto/presence-data'},
                            {text: 'Profile Data', link: '/reference/dto/profile-data'},
                            {text: 'Screenshot Data', link: '/reference/dto/screenshot-data'},
                            {text: 'Seen Data', link: '/reference/dto/seen-data'},
                            {text: 'Server Status Data', link: '/reference/dto/server-status-data'},
                            ...
                            {text: 'Session Config GOWS Data', link: '/reference/dto/session-config-gows-data'},
                            ...
                            {text: 'Session Create Data', link: '/reference/dto/session-create-data'},
                            ...
                            {text: 'Session Update Data', link: '/reference/dto/session-update-data'},
                            ...
                            {text: 'Vcard Contact Data', link: '/reference/dto/vcard-contact-data'},
                        ]
                    },
                    {
                        text: 'Enums',
